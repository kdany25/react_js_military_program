    ...
    <div className="newUser">
      ...
      <form className="newUserForm">
        <div className="newUserItem">
          ...
          <input name="pname" type="text" placeholder="john" onChange={handleChange} />
        </div>
        <div className="newUserItem">
          <label>Email</label>
        ...
        <div className="newUserItem">
          <label>Age</label>
          <input name="age"  type="text" placeholder="30" onChange={handleChange} />
        </div>
        <div className="newUserItem">
        ...
        <div className="newUserItem">
          ...
          <select className="newUserSelect" name="hospitalised" id="active">
